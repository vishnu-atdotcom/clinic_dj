...
SECRET_KEY = 'django-insecure-7s&2-z(^s-f^1ix@!y89aekzmr#poxhs(f406n5x_6m+qa)qc^'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # Stores the database file in the project directory
    }
}
...
# Base URL for static files (served in development)
STATIC_URL = '/static/'
